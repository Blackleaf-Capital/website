    ...
    return (
        <div className="space-y-8">
            <div className='w-[90%] mt-[4vh] mx-auto h-[80vh] bg-black rounded-2xl flex flex-col items-center justify-center text-white text-2xl'>
                <h1 className="font-primary text-4xl w-[50%] text-center">
                Bridging the gap between potential and Success
                </h1>
                <p className="text-[16px] w-[40%] my-5 text-center">We help students move from ambition to achievement through real-world experience and industry access.</p>
                <Link
                    to="/sponsors"
                    onClick={scrollToTop}
